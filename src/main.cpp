...
int main() {
   ...
   */
  PID controllerAngle;
  controllerAngle.Init(0.3, 0.006, 3.0);
  ...
  {
      Twiddle t;
      controllerAngle.Init(t.optimiseSteering());
  }

  if (optimiseSpeed && !optimiseAngle)
  {
      Twiddle t;
              ...
              if (length && length > 2 && data[0] == '4' && data[1] == '2') {
                  ...
                  if (s != "") {
                      ...
                      if (event == "telemetry") {
                          ...
                          controllerAngle.UpdateError(cte);
                          steer_value = controllerAngle.TotalError();
                          if (steer_value > 1)
                          {
                              steer_value = 1;
                          }
